...
import kr.or.ddit.company.community.service.CompanyAdminCommentAjaxService;
...
@Slf4j
@RestController
@RequestMapping("/ajax/company/adminComment")
@RequiredArgsConstructor
public class CompanyAdminCommentAjaxController {
	
	private CompanyAdminCommentAjaxService service;
