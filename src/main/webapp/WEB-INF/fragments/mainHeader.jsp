                                        ...
                                        <ul class="services">
                                            <li class="half_col">
                                                ...
                                                <a href="/companysignup"
                                                    data-nav-track="ga_lead|main-gnb|layer_comp_service|company_join">회원가입</a>
                                            </li>
                    ...
                    <div class="wrap_gnb">
                        ...
                        <div class="major">
                            ...
                            <ul class="depth2">
                                ...
                                <li><a href="/member/interview/review"><span class="txt">면접후기</span></a></li>
                        ...
                        <div class="major">
                            ...
                            <ul class="depth2">
                                <li><a href="/member/board/commu_board?type=CATE-001"><span class="txt">취업준비</span></a>
                                </li>
                                <li><a href="/member/board/commu_board?type=CATE-002"><span class="txt">회사문화</span></a>
                                </li>
                                <li><a href="/member/board/commu_board?type=CATE-003"><span class="txt">자유게시판</span></a>
                                </li>
                            </ul>
                        </div>
                        <div class="major">
                        ...
                        <div class="major">
                            ...
                            <ul class="depth2">
                                <li><a href="/member/board/commu_board?type=BRDD-003"><span class="txt">공지사항</span></a>
                                </li>
                                <li><a href="/member/board/commu_board?type=BRDD-001"><span class="txt">문의게시판</span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div id="sri_index">
                    <div class="panel_menu menu">
                        ...
                        <div class="major">
                            ...
                            <ul class="depth2">
                                <li><a href="/member/board/commu_board?type=CATE-001" class="new"><span
                                            class="txt">취업준비</span></a></li>
                                <li><a href="/member/board/commu_board?type=CATE-002"><span class="txt">회사문화</span></a>
                                </li>
                                <li><a href="/member/board/commu_board?type=CATE-003"><span class="txt">자유게시판</span></a>
                                </li>
                        ...
                        <div class="minor">
                            <ul class="items">
                                <li><a href="/member/board/admin_board?type=BRDD-002"><span
                                            class="material-symbols-outlined">headset_mic</span>고객센터</a></li>
                                <li><a href="/member/board/admin_board?type=BRDD-003&tab=notice"><span
                                            class="material-symbols-outlined">campaign</span>공지사항</a></li>
                                <li><a href="/member/board/admin_board?type=BRDD-003&tab=event"><span
                                            class="material-symbols-outlined">celebration</span>이벤트</a></li>
                            </ul>
                        </div>
                        <div class="major">
                        ...
                        <div class="personalize">
                            <a href="/zf_user/member/persons/main" class="myhome">MY<svg class="arrow"
                                    aria-hidden="true" focusable="false">
                                    <use xlink:href="#svg_gnb_profile_bracket"></use>
                                </svg></a>
                            <ul class="items">
                                <li><a href="/mypage/resume/list"
                                        data-nav-track="ga_lead|main-gnb|total_menu|resume-manage">이력서 관리</a></li>
                                <li><a href="/member/mypage/scrab_recruit"
                                        data-nav-track="ga_lead|main-gnb|total_menu|scrap">스크랩</a></li>
                                ...
                                <li><a href="/zf_user/jobs/read-jobs"
                                        data-nav-track="ga_lead|main-gnb|total_menu|recent">최근본</a></li>
                            </ul>
                        </div>
                    </div>
