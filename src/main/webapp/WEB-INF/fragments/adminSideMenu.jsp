 ...
 <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
   ...
   <ul class="menu-inner py-1">
	...
	<li class="menu-item">
     ...
     <li class="menu-item">
       <a href="/ajax/admin/common/users?userRole=ROLE_USER" class="menu-link">
         <i class="menu-icon tf-icons bx bx-user"></i>
         <div data-i18n="Basic">일반회원</div>
       </a>
     </li>
     <li class="menu-item">
       <a href="/ajax/admin/common/users?userRole=ROLE_COMPANY" class="menu-link">
         <i class="menu-icon tf-icons bx bx-building"></i>
         <div data-i18n="Basic">기업회원</div>
       </a>
     </li>
     <li class="menu-item">
       <a href="/ajax/admin/common/users?userRole=ROLE_ADMIN" class="menu-link">
	 ...
	 <li class="menu-item">
       <a href="/ajax/admin/board/admin_board/BRDD-003" class="menu-link">
         <i class="menu-icon tf-icons bx bx-envelope-open"></i>
         <div data-i18n="Basic">공지사항</div>
       </a>
     </li>
	 <li class="menu-item">
       <a href="/ajax/admin/board/admin_board/BRDD-002" class="menu-link">
         <i class="menu-icon tf-icons bx bx-clipboard-detail"></i>
         <div data-i18n="Basic">FAQ게시판</div>
       </a>
     </li>
	 <li class="menu-item">
       <a href="/ajax/admin/board/admin_board/BRDD-001" class="menu-link">
