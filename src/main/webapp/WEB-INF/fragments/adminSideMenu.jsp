 ...
 <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
   ...
   <ul class="menu-inner py-1">
	...
	<li class="menu-item">
	 ...
	 <li class="menu-item">
       <a href="/admin/board/admin_board?type=BRDD-003" class="menu-link">
         <i class="menu-icon tf-icons bx bx-envelope-open"></i>
         <div data-i18n="Basic">공지사항</div>
       </a>
     </li>
	 <li class="menu-item">
       <a href="/admin/board/admin_board?type=BRDD-002" class="menu-link">
         <i class="menu-icon tf-icons bx bx-clipboard-detail"></i>
         <div data-i18n="Basic">FAQ게시판</div>
       </a>
     </li>
	 <li class="menu-item">
       <a href="/admin/board/admin_board?type=BRDD-001" class="menu-link">
