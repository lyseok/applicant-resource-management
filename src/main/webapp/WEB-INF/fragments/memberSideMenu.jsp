    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-item">
        ...
        <ul class="menu-sub">
          ...
          <li class="menu-item">
            <a href="/mypage/project/my_applicant" class="menu-link">
              <div data-i18n="Notifications">내 지원 관리</div>
            </a>
          </li>
        </ul>
      </li>
      ...
      <li class="menu-item">
        <a href="/member/mypage/scrabRecruit/list" class="menu-link">
      ...
      <li class="menu-item">
        <a href="/mypage/interview" class="menu-link">
          <i class="menu-icon tf-icons bx bx-list-ul-square"></i>
          <div data-i18n="Basic">면접 목록</div>
        </a>
      </li>
      <!-- 여기까지 사이드바 작업하는 곳 -->
