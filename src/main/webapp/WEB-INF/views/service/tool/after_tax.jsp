...
<body>
    ...
    <section class="wrap_enquiry">
        ...
        <div class="enquiry">
            ...
            <div class="form_title" id="title_salary">월 실수령액</div>
            <div class="form_salary same">
                <span class="sri_input2 large right"><input type="text" id="pay" placeholder="0" title="실수령액" value="" maxlength="12"></span>
                ...
                <div class="control">
                    ...
                    <p class="btn">
                        ...
                        <span id="calc_btn_area" style="margin-left: 5px;"><button type="button" class="btn_basic_type02" id="calc_annual_income">연봉 조회</button></span>
    ...
    <section class="wrap_result">
        ...
        <div class="title wide">
            <span class="text">예상 연봉</span>
            <div class="toolTipWrap">
                <button type="button" class="icon_tooltip" onmouseover="Saramin.favorTooltip(this, 'on');" onmouseout="Saramin.favorTooltip(this, 'off');" onfocus="Saramin.favorTooltip(this, 'on');" onblur="Saramin.favorTooltip(this, 'off');"><span class="hidden">툴팁</span></button>
                <div class="toolTip" style="margin-left:-203px;width:365px">
                    <span class="tail tail_bottom_center"></span>
                    <div class="toolTipCont txtLeft">
                        <p class="txt">
                            실 지급 금액에서 공제액과의 합계에 근거한 연봉 금액입니다.
                        </p>
                    </div>
                </div>
            </div>
            <span class="result_value" id="total_tax_deduction_plus_income"><strong>0</strong>원</span>
        </div>
        <div class="result_list">
            ...
            <!--
                <dl class="summary">
                    ...
                    <dd class="total_tax_deduction" id="count"><span>0</span>번</dd>
                </dl>
                -->
        </div>
        <div class="wrap_btns">
