...
<body>
	...
	<div class="p-3 pt-4 pb-4 bg-violet03 rounded d-flex justify-content-between align-items-center mb-5">
		...
		<div class="">
			<button type="button" class="BtnType SizeXL pt-2 pb-2 h-100 GrayInvert fs-6">파일로 등록</button>
			<a class="BtnType SizeXL pt-2 pb-2 h-100 fs-6" href="/write/new">자소서 등록하기</a>
		</div>
	</div>
			...
			<c:forEach items="${introductionList }" var="introduction">
				<ul>
					<li class="pt-5 pb-5 border-bottom d-flex justify-content-between align-items-center">
						<div class="">
							<a class="d-block h4 fw-bold" href="<c:url value=""/>">${introduction.introductionName}</a>
							<p class="text-truncate">${introduction.introductionContent}</p>
						</div>
						<div class="d-flex gap-1">
							<a class="BtnType SizeXL pt-2 pb-2 h-100 GrayInvert fs-6">수정하기</a>
							<a class="BtnType SizeXL pt-2 pb-2 h-100 GrayInvert fs-6">삭제하기</a>
						</div>
					</li>
				</ul>
			</c:forEach>
