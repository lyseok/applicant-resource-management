...
<div class="wrap_sub_curation priority_top_list">
				        <div class="sub_curation_swiper swiper-container-horizontal swiper-initialized swiper-horizontal">
				            <div class="slide_btn_wrap">
				                <button type="button" class="slide_btn_type3 prev swiper-prev ga_data_layer swiper-button-disabled" data-ga_data_layer="ga_lead|public-recruit|noti1|pre" tabindex="-1" role="button" aria-label="Previous slide" aria-disabled="true" disabled="" aria-controls="swiper-wrapper-ca541da66a77eb10d"><span class="blind">이전</span>
				                </button>
				                <button type="button" class="slide_btn_type3 next swiper-next ga_data_layer" data-ga_data_layer="ga_lead|public-recruit|noti1|next" tabindex="0" role="button" aria-label="Next slide" aria-disabled="false" aria-controls="swiper-wrapper-ca541da66a77eb10d"><span class="blind">다음</span>
				                </button>
				            </div>
				            <ul class="sub_curation_list swiper-wrapper" id="swiper-wrapper-ca541da66a77eb10d" aria-live="polite">
				                <li class="swiper-slide swiper-slide-visible swiper-slide-active" style="width: 240px; margin-right: 15px;" role="group" aria-label="1 / 30">
				                ...
				                <li class="swiper-slide swiper-slide-visible swiper-slide-next" style="width: 240px; margin-right: 15px;" role="group" aria-label="2 / 30">
				                ...
				                <li class="swiper-slide swiper-slide-visible" style="width: 240px; margin-right: 15px;" role="group" aria-label="3 / 30">
				                ...
				                <li class="swiper-slide swiper-slide-visible" style="width: 240px; margin-right: 15px;" role="group" aria-label="4 / 30">
				                ...
				                <li class="swiper-slide swiper-slide-visible" style="width: 240px; margin-right: 15px;" role="group" aria-label="5 / 30">
				                ...
				                <li class="swiper-slide" style="width: 240px; margin-right: 15px;" role="group" aria-label="6 / 30">
				                ...
				                <li class="swiper-slide" style="width: 240px; margin-right: 15px;" role="group" aria-label="7 / 30">
				                ...
				                <li class="swiper-slide" style="width: 240px; margin-right: 15px;" role="group" aria-label="8 / 30">
				                ...
				                <li class="swiper-slide" style="width: 240px; margin-right: 15px;" role="group" aria-label="9 / 30">
				                ...
				                <li class="swiper-slide" style="width: 240px; margin-right: 15px;" role="group" aria-label="10 / 30">
				                ...
				                <li class="swiper-slide" style="width: 240px; margin-right: 15px;" role="group" aria-label="11 / 30">
				                ...
				                <li class="swiper-slide" style="width: 240px; margin-right: 15px;" role="group" aria-label="12 / 30">
				                ...
				                <li class="swiper-slide" style="width: 240px; margin-right: 15px;" role="group" aria-label="13 / 30">
				                ...
				                <li class="swiper-slide" style="width: 240px; margin-right: 15px;" role="group" aria-label="14 / 30">
				                ...
				                <li class="swiper-slide" style="width: 240px; margin-right: 15px;" role="group" aria-label="15 / 30">
				                ...
				                <li class="swiper-slide" style="width: 240px; margin-right: 15px;" role="group" aria-label="16 / 30">
				                ...
				                <li class="swiper-slide" style="width: 240px; margin-right: 15px;" role="group" aria-label="17 / 30">
				                ...
				                <li class="swiper-slide" style="width: 240px; margin-right: 15px;" role="group" aria-label="18 / 30">
				                ...
				                <li class="swiper-slide" style="width: 240px; margin-right: 15px;" role="group" aria-label="19 / 30">
				                ...
				                <li class="swiper-slide" style="width: 240px; margin-right: 15px;" role="group" aria-label="20 / 30">
				                ...
				                <li class="swiper-slide" style="width: 240px; margin-right: 15px;" role="group" aria-label="21 / 30">
				                ...
				                <li class="swiper-slide" style="width: 240px; margin-right: 15px;" role="group" aria-label="22 / 30">
				                ...
				                <li class="swiper-slide" style="width: 240px; margin-right: 15px;" role="group" aria-label="23 / 30">
				                ...
				                <li class="swiper-slide" style="width: 240px; margin-right: 15px;" role="group" aria-label="24 / 30">
				                ...
				                <li class="swiper-slide" style="width: 240px; margin-right: 15px;" role="group" aria-label="25 / 30">
				                ...
				                <li class="swiper-slide" style="width: 240px; margin-right: 15px;" role="group" aria-label="26 / 30">
				                ...
				                <li class="swiper-slide" style="width: 240px; margin-right: 15px;" role="group" aria-label="27 / 30">
				                ...
				                <li class="swiper-slide" style="width: 240px; margin-right: 15px;" role="group" aria-label="28 / 30">
				                ...
				                <li class="swiper-slide" style="width: 240px; margin-right: 15px;" role="group" aria-label="29 / 30">
				                ...
				                <li class="swiper-slide" style="width: 240px; margin-right: 15px;" role="group" aria-label="30 / 30">
...
<div class="common_recruilt_list">
				    ...
				    <div class="newcomer_sub_bottom">
				        ...
				        <div class="wrap_sub_curation priority_rand_list">
				            <div class="sub_curation_swiper swiper-container-horizontal swiper-initialized swiper-horizontal swiper-backface-hidden">
				                <div class="slide_btn_wrap">
				                    <button type="button" class="slide_btn_type3 prev swiper-prev ga_data_layer swiper-button-disabled" data-ga_data_layer="ga_lead|public-recruit|noti4|pre" tabindex="-1" role="button" aria-label="Previous slide" aria-disabled="true" disabled="" aria-controls="swiper-wrapper-1c306245b7272e4b"><span class="blind">이전</span>
				                    </button>
				                    <button type="button" class="slide_btn_type3 next swiper-next ga_data_layer" data-ga_data_layer="ga_lead|public-recruit|noti4|next" tabindex="0" role="button" aria-label="Next slide" aria-disabled="false" aria-controls="swiper-wrapper-1c306245b7272e4b"><span class="blind">다음</span>
				                    </button>
				                </div>
				                <ul class="sub_curation_list swiper-wrapper" id="swiper-wrapper-1c306245b7272e4b" aria-live="polite">
				                    <li class="swiper-slide swiper-slide-visible swiper-slide-active" style="width: 240px; margin-right: 15px;" role="group" aria-label="1 / 8">
				                    ...
				                    <li class="swiper-slide swiper-slide-visible swiper-slide-next" style="width: 240px; margin-right: 15px;" role="group" aria-label="2 / 8">
				                    ...
				                    <li class="swiper-slide swiper-slide-visible" style="width: 240px; margin-right: 15px;" role="group" aria-label="3 / 8">
				                    ...
				                    <li class="swiper-slide swiper-slide-visible" style="width: 240px; margin-right: 15px;" role="group" aria-label="4 / 8">
				                    ...
				                    <li class="swiper-slide swiper-slide-visible" style="width: 240px; margin-right: 15px;" role="group" aria-label="5 / 8">
				                    ...
				                    <li class="swiper-slide" style="width: 240px; margin-right: 15px;" role="group" aria-label="6 / 8">
				                    ...
				                    <li class="swiper-slide" style="width: 240px; margin-right: 15px;" role="group" aria-label="7 / 8">
				                    ...
				                    <li class="swiper-slide" style="width: 240px; margin-right: 15px;" role="group" aria-label="8 / 8">
