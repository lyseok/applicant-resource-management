<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
  ...
  <body class="mypage-body">
    <div class="container-fluid">
          ...
          <div class="col-md-6">
            <div class="user-info">
              ...
              <div class="user-details">
                <h4>기업명 <i class="fas fa-chevron-right"></i></h4>
      ...
      <div class="stats-overview mb-5">
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="stats-card">
              <h5 class="stats-title">받은 제안</h5>
              <div class="row text-center">
                <div class="col-3">
                  <div class="stat-item">
                    <div class="stat-number">3,456</div>
                    <div class="stat-label">포지션 제안</div>
                  </div>
                </div>
                <div class="col-3">
                  <div class="stat-item">
                    <div class="stat-number">2,134</div>
                    <div class="stat-label">면접 요청</div>
                  </div>
                </div>
                <div class="col-3">
                  <div class="stat-item">
                    <div class="stat-number">1,789</div>
                    <div class="stat-label">이력서 요청</div>
                  </div>
                </div>
                <div class="col-3">
                  <div class="stat-item">
                    <div class="stat-number">987</div>
                    <div class="stat-label">이력서 열람</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="chart-card">
              ...
              <div class="ranking-list">
                <div class="ranking-item">
                  ...
                  <span class="applicants">1,234명</span>
                </div>
                <div class="ranking-item">
                  <span class="rank">2</span>
                  <span class="job-title">백엔드 개발자</span>
                  <span class="applicants">987명</span>
                </div>
                <div class="ranking-item">
                  <span class="rank">3</span>
                  <span class="job-title">풀스택 개발자</span>
                  <span class="applicants">856명</span>
                </div>
                <div class="ranking-item">
                  <span class="rank">4</span>
                  <span class="job-title">데이터 분석가</span>
                  <span class="applicants">743명</span>
                </div>
                <div class="ranking-item">
                  <span class="rank">5</span>
                  <span class="job-title">UI/UX 디자이너</span>
                  <span class="applicants">692명</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="chart-card">
          <div class="calendar-header">
            ...
            <div class="calendar-nav">
              ...
              <span class="calendar-title" id="calendarTitle">2025년 7월</span>
              <div class="view-controls">
                <button class="btn btn-sm btn-dark active">month</button>
    ...
    <script src="/js/company/indexTest.js"></script>
  </body>