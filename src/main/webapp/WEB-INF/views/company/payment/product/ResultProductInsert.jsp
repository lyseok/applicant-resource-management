...
<body>
	<div class="container mt-5">
		...
		<table class="table table-bordered">
			...
			<tr>
				<th>상품 이미지</th>
				<td><c:if test="${not empty productVO.productImg}">
						<img src="${productVO.productImg}" class="img-thumbnail"
							style="max-width: 300px;">
					</c:if> <c:if test="${empty productVO.productImg}">
                    이미지 없음
                </c:if></td>
			</tr>
		</table>
		...
		<div class="text-center mt-4">
			<a href="/admin/add" class="btn btn-primary">다시 등록하기</a> <a
				href="/admin/product/list" class="btn btn-secondary">목록으로</a>
		</div>
	</div>
</body>
</html>