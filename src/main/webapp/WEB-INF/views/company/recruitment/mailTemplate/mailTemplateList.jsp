	...
	<body onbeforeunload="showLoading()">
			...
			<div class="modal-dialog modal-dialog-centered modal-xl">
				<div class="modal-content">
					<div class="modal-header border-0">
						<h5 class="modal-title fs-5 fw-bold text-success" id="templateModalLabel">메일 템플릿 등록</h5>
						<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="닫기"></button>
					</div>
					<div class="modal-body py-4">
						<form id="templateForm">
							<div class="mb-3">
								<label for="templateTitle" class="form-label fs-16 fw-bold text-dark required mb-0">제목</label>
								<input type="text" class="form-control" id="templateTitle" placeholder="템플릿 제목을 입력하세요" required />
							</div>
							<div class="mb-3">
								<label for="templateContent" class="form-label fs-16 fw-bold text-dark required mb-0">내용</label>
					...
					<div class="modal-footer border-0 justify-content-center">
						...
						<button type="submit" class="btn btn_violet w140 justify-content-center" form="templateForm">등록</button>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="modal fade" id="templateDetailModal" tabindex="-1" aria-labelledby="templateDetailModalLabel"
			...
			<div class="modal-dialog modal-dialog-centered modal-xl">
				<div class="modal-content">
					<div class="modal-header border-0">
						<h5 class="modal-title fs-5 fw-bold text-success" id="templateDetailModalLabel">메일 템플릿 상세</h5>
						<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="닫기"></button>
					</div>
					<div class="modal-body py-4">
					...
					<div class="modal-footer border-0 justify-content-center">
						<button type="button" class="btn btn_red_line fw-500" id="deleteTemplateBtn">삭제</button>
						<button type="button" class="btn btn_violet w140 justify-content-center" id="editTemplateBtn">수정</button>
					</div>
				</div>
			</div>
		</div>
