	...
	<body>
		...
		<div class="d-flex flex-wrap gap-4 notice_form_wrap">
			...
			<div class="d-flex notice_form gap-4">
				...
				<div class="flex-fill">
					<label class="form-label fs-16 fw-bold text-dark required">경력</label> <select id="yearCode" name="yearCode"
						class="form-select">
			...
			<div class="d-flex notice_form gap-4">	
				<div class="flex-fill">
					<label class="form-label fs-16 fw-bold text-dark required">학력</label> <select id="eduCode" name="education.codeDetailNo"
			...
			<div class="notice_form">
				...
				<div class="d-flex gap-2">
					...
					<button type="button" class="btn btn_violet_line text-nowrap w140 justify-content-center" onclick="addPositionTag()">추가</button>
				</div>
			...
			<div class="notice_form">
				...
				<div class="d-flex flex-column gap-2">
					<div class="d-flex gap-2">
						...
						<button type="button" id="addSkillBtn" class="btn btn_violet_line text-nowrap w140 justify-content-center" onclick="addSkill()">추가</button>
					</div>
