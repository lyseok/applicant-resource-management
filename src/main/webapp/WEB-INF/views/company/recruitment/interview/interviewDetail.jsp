        ...
        <div class="bg-white rounded-4 mb-5">
          ...
          <div id="videoInterviewArea" style="display:none;" class="mb-5 ">
            ...
            <div class=" d-flex justify-content-end w-100 gap-2">
              <button class="btn btn_gray_line" id="joinVideoInterviewBtn" data-bs-toggle="modal"
          ...
          <div class="d-flex align-items-end justify-content-between">
            ...
            <div class="d-flex gap-2 justify-content-end mt-3">
              <div class='btn btn_gray_line saveInterview' data-bs-toggle="modal" data-bs-target="#editInterviewModal"
