<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
  ...
  <head>
    ...
    <script defer src="/js/member/project/announcement/announcementList.js"></script>
    <style>
      .tab-btn {
        border: none;
        background: none;
      ...
      .card-post {
        border-radius: 20px;
        box-shadow: 0 2px 22px 0 rgba(170, 125, 241, 0.09);
      }

      .card-post:hover {
        box-shadow: 0 4px 28px 0 rgba(120, 80, 210, 0.16);
      }
      ...
      <div class="row align-items-center mb-4 g-2">
        <div class="col-12 col-md-9">
          <div class="input-group mb-2 search-mainbox">
            ...
            <input type="text" class="form-control border-start-0" placeholder="팀 프로젝트, 사이드프로젝트를 검색해보세요!"
              id="titleInput">
            <button class="btn btn-purple" id="searchBtn" type="button"
              style="background:#ae8be1;color:#fff;">검색</button>
          </div>
          <div class="input-group">
            <span class="input-group-text bg-white border-end-0">
              <i class="bi bi-hash" style="font-size:1.17em; color:#ae8be1;"></i>
            </span>
            <input type="text" class="form-control border-start-0" placeholder="태그로 검색해보세요!" id="tagInput"
              autocomplete="off">
            <button class="btn btn-outline-secondary ms-2" id="resetBtn" type="button"><i
                class="bi bi-arrow-clockwise"></i> 초기화</button>
          </div>
