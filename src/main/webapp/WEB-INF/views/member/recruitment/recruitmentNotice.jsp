...
.btn_scrap svg { transition: fill 0.2s; }
.btn_scrap .txt_scrap { font-size: 14px; color: #333; }
</style>
  </head>
  <body>
	                ...
	                <div class="wrap_jv_header">
	                  ...
	                  <div class="jv_header">
	                    <div class="title_inner">
	                      ...
	                      <button type="button" class="btn_jview spr_jview btn_interest" id="scrab_company">
	                        <svg
	                          width="16"
	                          height="16"
	                          viewBox="0 0 16 16"
    					...
    					<path d="M12 .587l3.668 7.429 8.2 1.193-5.934 5.784 1.4 8.172L12 18.896l-7.334 3.869 1.4-8.172L.132 9.209l8.2-1.193z"
						fill="white" />
						</svg>
	                      <span class="txt_scrap">14(공고스크랩 갯수)</span>
						</button>
	                    <div class="btn_apply">
	                      <span class="dday">D-41(시작기한-마감기한)</span>
					        ...
					        <div class="wrap_info">
					            <div class="tit_area">
					                <div class="basic_info">
					                    <h3 id="companyh3">
					                    	<button type="button" class="btn_jview btn_jview_round btn_interest">
