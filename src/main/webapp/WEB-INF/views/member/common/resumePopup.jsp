<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	<%@ taglib uri="jakarta.tags.core" prefix="c" %>
		...
		<body>
			<div class="resume-main-wrap resume_detail_wrap" style="width: 950px; margin:0 auto;">
				<!-- Header -->
				<div class="resume-header">
					...
					<div class="header-info">
						<div class="d-flex align-items-center">
							<span class="name lh1">${resumeList.userName }</span> <span class="age lh1">${resumeList.birth }</span>
						</div>
						...
						<c:if test="${resumeList.resumeNo eq resumeList.mainResumeNo }">
								...
								<li>
									<div class="list-content">
										<div class="">
											...
											<!-- 부서/직무 -->
											<div>
												<c:if test="${career.department}">${career.department }/</c:if> ${career.responsibility }
											</div>
										</div>
										<!-- 경력기간 -->
							...
							<c:forEach items="${resumeList.languageSkillList }" var="lang">
								<li>
									<div class="list-content">
										...
										<!-- 어학 자격명 -->
										<div>
											<c:if test="${not empty lang.languageExamLevelCode }"><span>(${lang.languageExamLevelCode } /
													${lang.languageCodeName })</span></c:if>
											<c:if test="${not empty lang.languageExamScore }"><span>(${lang.languageExamScore } /
													${lang.languageCodeName })</span></c:if>
										</div>
							...
							<c:forEach items="${resumeList.militaryList }" var="mil">
								<li>
									...
									<div class="list-content">
										...
										<div><span class="text-secondary fs-14">
												<c:out value="${mil.militaryReason}" default="" />
											</span></div> <!-- 미필사유 -->
