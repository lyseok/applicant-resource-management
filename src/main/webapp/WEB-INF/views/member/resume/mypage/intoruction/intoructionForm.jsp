		    ...
		    <div class="introduct_add_wrap">
		        <div class="introduct_area" id="introduct01">
		            <div class="mb-3">
		                ...
		                <form:input path="introductionList[0].introductionName" cssClass="form-control" id="title1" placeholder="자소서 이름을 입력해주세요."/>
		            ...
		            <div class="mb-3">
		                ...
		                <form:input path="introductionList[0].introductionQuestion" cssClass="form-control" id="question1" placeholder="지원동기, 입사 후 포부 같은 내용을 입력해주세요."/>
		                <form:errors path="introductionList[0].introductionQuestion" cssClass="text-danger"/>
		            </div>
		            <div class="mb-3">
		                <label for="content1" class="form-label fw-bold h5">자소서 내용</label>
		                <form:textarea path="introductionList[0].introductionContent" cssClass="form-control" id="content1" rows="10"/>
		                <form:errors path="introductionList[0].introductionContent" cssClass="text-danger"/>
		            </div>
		            <div class="mb-3">
