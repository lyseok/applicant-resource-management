			...
			<form:form modelAttribute="company" method="post">
				...
				<div class="write_base">
					<div class="item">
						...
						<div class="TypoBox">
							<input name="business.brNumber" id="brNumber" type="text"
								class="Typo SizeL defalt" maxlength="12"
								value="${company.business.brNumber}" autocapitalize="off"
				...
				<div id="area_input_company" style="display: none;">
					<div class="write_base">
						...
						<div class="item">
							...
							<div class="TypoBox">
								<input name="ceoName" id="ceoName" value="${company.ceoName}"
									type="text" class="Typo SizeL defalt" maxlength="50"
						...
						<div class="item">
							...
							<div class="TypoBox">
								<input name="comNum" id="comNum" value="${company.comNum}"
									type="text" class="Typo SizeL defalt" maxlength="11"
						...
						<div class="item adress_column">
							...
							<div class="input_collect TypoBox defalt">
								<input type="text" name="comAddr1" id="comAddr1"
									value="${company.comAddr1 }" class="Typo SizeL defalt"
									placeholder="기본 주소">
							</div>
						...
						<div class="item">
							...
							<div class="input_collect TypoBox defalt" style="display: flex; align-items: center; gap: 10px;">
								<input name="userId" id="id" type="text"
									class="Typo SizeL defalt" value="${company.userId }"
							...
							<div class="alert_box">
								<p class="alert_column focus_txt" id="idFocusMsg"
									style="display: none; color: red;">4 ~ 20자의 영문, 숫자와
									특수문자'_'만 사용해주세요.</p>
								<p class="alert_column good_txt" id="idCheckMsg2"
									style="display: none">사용 가능한 아이디입니다.</p>
					...
					<div class="btn_join">
						<button type="submit" id="btn_submit"
							class="inp_join BtnType SizeL defalt btn_input_complete" disabled>회원가입
							완료</button>
					</div>
			</form:form>
			<!-- **form:form 닫기** -->
