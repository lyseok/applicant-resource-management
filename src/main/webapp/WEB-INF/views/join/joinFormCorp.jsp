		    ...
		    <div id="area_input_company" style="display: none;">
		        <div class="write_base">
		            ...
		            <div class="item">
		                ...
		                <div class="TypoBox">
		                    <input name="company_nm" id="company_nm" type="text" class="Typo SizeL defalt" maxlength="25" onmousedown="pushDataLayer('ga_lead', 'company_join', 'company_nm_input', 'click_company_nm');" autocapitalize="off" autocomplete="off" placeholder="기업명 입력">
		                </div>
