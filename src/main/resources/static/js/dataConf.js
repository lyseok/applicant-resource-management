...
export const templateData = {
  title: '백엔드 개발자 입사제안(Spring, Oralce)',
  content: `안녕하세요.
kt ds 인사담당자입니다.

귀하의 우수한 경력과 역량을 확인한 결과, 당사에서 진행 중인 백엔드 개발자 포지션과 적합하다고 판단하여 입사 제안을 드리고자 합니다.
...
[근무 조건 및 지원]
	...
	•	체계적인 교육 프로그램과 성장 지원 제도

귀하께서 당사와 함께하게 된다면, 뛰어난 전문성과 잠재력이 시너지 효과를 발휘하여 더 큰 성장을 이루실 수 있을 것이라 확신합니다.
