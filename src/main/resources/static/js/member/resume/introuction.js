...
document.addEventListener("DOMContentLoaded", function(){
   ...
   addBtn.addEventListener("click", (e)=>{
      ...
      html = `<div class="mb-3">
              <label for="title${totalNum}" class="form-label h5 fw-bold">자소서 명</label>
              <input type="text" class="form-control" id="title${totalNum}" name="introductionList[${currentIdx}].introductionName" placeholder="자소서 이름을 입력해주세요.">
            </div>
            <div class="mb-3">
              <label for="question${totalNum}" class="form-label h5 fw-bold">문항 ${totalNum}</label>
              <input type="text" class="form-control" id="question${totalNum}" name="introductionList[${currentIdx}].introductionQuestion" placeholder="지원동기, 입사 후 포부 같은 내용을 입력해주세요.">
            </div>
            <div class="mb-3">
              <label for="content${totalNum}" class="form-label fw-bold h5">내용</label>
              <textarea class="form-control" id="content${totalNum}" name="introductionList[${currentIdx}].introductionContent" rows="10">${introductionContent}</textarea>
            </div>
            <div class="mb-3">
