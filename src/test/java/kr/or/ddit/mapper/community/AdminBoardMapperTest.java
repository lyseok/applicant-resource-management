...
class AdminBoardMapperTest {
	...
	void testSelectAdminBoard() {
		AdminBoardVO board = mapper.selectAdminBoard("ABNO000003");
	...
	void testInsertAdminBoard() {
		...
		log.info("{}", mapper.selectAdminBoard("ABNO000003"));
	}
	...
	void testDeleteAdminBoard() {
		mapper.deleteAdminBoard("ABNO000003");
		assertNotNull(mapper.selectAdminBoard("ABNO000003"));
	}
